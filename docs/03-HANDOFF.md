...
- Opens: **sl-0075 (WALKABLE WOODS — the designer's second
  ...
  woods round is its fix arm)** · **sl-0041 (rehearsal — belts
  BUILT as behavior 17 exactly per the sl-0073 ruling +
  planning's shaping, sl-0074 verified; designer reviewing the
  blended map; watershed seams landed in round 2)** · standing
