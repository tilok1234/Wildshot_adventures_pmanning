...
**Current questionnaire position:** CORE-01 through CORE-18 and CORE-20 through CORE-55 answered; CORE-14 remains provisional/test-gated; only CORE-19 remains open and active. (For the live position, `notes/INTERVIEW_STATE.md` is authoritative.)
...
1. `10-LIVING_DESIGN_QUESTIONNAIRE.md` — authoritative detailed interview record, integrated through CORE-55 except CORE-19, with CORE-19 marked active.
