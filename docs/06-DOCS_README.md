...
**Current questionnaire position:** CORE-01 through CORE-16 and CORE-21 through CORE-55 answered; CORE-14 remains provisional/test-gated; CORE-17 through CORE-19 remain open; CORE-20 is the active question. (For the live position, `notes/INTERVIEW_STATE.md` is authoritative.)
...
1. `10-LIVING_DESIGN_QUESTIONNAIRE.md` — authoritative detailed interview record, integrated through CORE-55 with CORE-20 marked active.
