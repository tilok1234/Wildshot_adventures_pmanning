...
**Current questionnaire position:** CORE-01 through CORE-16 and CORE-21 through CORE-41 answered; CORE-14 remains provisional/test-gated; CORE-17 through CORE-20 remain open; CORE-42 is the active unanswered question. (For the live position, `notes/INTERVIEW_STATE.md` is authoritative.)
...
1. `10-LIVING_DESIGN_QUESTIONNAIRE.md` — authoritative detailed interview record, integrated through CORE-41 with CORE-42 marked active.
